 ...
 * @author cristi
 */
public class StringSocketServer {
    ...
    private String ByteArr2String(byte[] ba, int iStart, int iLen) {
     ...
     //       sRet = new String(ba, iStart, iLen);
     //       bDec = sRet.getBytes();
     //       System.out.println(ByteArr2HexString(ba, iStart,  iLen));
     //       System.out.println(ByteArr2HexString(bDec, 0,  iLen));
        } catch (Exception e) {
        }
